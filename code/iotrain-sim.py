...
def main(args):
    ...
    if not os.path.isdir(Storyboard.IOTRAIN_DATABASE_PATH):
        print(Storyboard.ERROR_DATABASE_NOT_FOUND.format(
            Storyboard.IOTRAIN_DATABASE_PATH))
        sys.exit(3)
    ...
    if use_cli:
        ...
        # Used for debugging purposes, to make sure messages are displayed
        time.sleep(1)
